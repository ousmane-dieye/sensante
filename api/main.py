...
class PatientInput(BaseModel):
    ...
    toux: bool = Field(
        ...,
        description="Présence de toux"
    )

    fatigue: bool = Field(
        ...,
        description="Présence de fatigue"
    )
...
def predict(patient: PatientInput):
    ...
    Reçoit les symptômes en JSON et renvoie :
    - le diagnostic,
    - la probabilité,
    - une recommandation.
    """
    ...
    messages = {
        ...
        "grippe": (
            "Suspicion de grippe. "
            "Repos et hydratation recommandés."
        ),
